...
%     teta1=parameter(31); %Generating the true parameters teta with length 31
    ...
    for i=1:50
        ...
        u1(i,b)=Usm(xs1,i,200,sig2,4); %Calculating the Usm
        l1(i,b)=Lsm(xs1,i,200,sig2,4); %Calculating the Lsm
        zsu1(i,b)=zsm_u(u1(i,b),200,i,sig2,4); %calculating the upper bound of Reconstruction erro
        zsl1(i,b)=zsm_l(l1(i,b),200,i,sig2,4); %calculating the lower bound of Reconstruction erro
